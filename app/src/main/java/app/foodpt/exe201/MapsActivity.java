...
import app.foodpt.exe201.databinding.ActivityMapsBinding;
...
// Lắng nghe sự thay đổi trong EditText
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMapClickListener(latLng -> {
            ...
            String formattedDistance = String.format("%.1f", distanceInKm);

            // Hiển thị khoảng cách
            Toast.makeText(this, "Khoảng cách tới quán: " + formattedDistance + " km", Toast.LENGTH_LONG).show();
    ...
    private void getAddressFromLatLng(LatLng latLng, TextView textView) {
        ...
        try {
            ...
            if (addresses != null && addresses.size() > 0) {
                ...
                textView.setText("Không tìm thấy địa chỉ");
            }
        } catch (IOException e) {
            e.printStackTrace();
