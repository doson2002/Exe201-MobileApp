...
//    private static final String BASE_URL = "http://192.168.1.9:8080/api/v1/";
    ...
    public static final String UPDATE_SUPPLIER_CASH  = BASE_URL + "supplier_info/update_cash";
    public static final String UPDATE_PAYMENT_INFORMATION  = BASE_URL + "supplier_info/update_payment_information";
 ...
 public static final String GET_RATING_BY_SUPPLIER_ID = BASE_URL + "order_ratings/get_rating_by_supplier_id";
    ...
    public static final String UPDATE_ORDER_STATUS = BASE_URL + "food_orders/update_order_status";

    public static final String DELETE_FOOD_ORDER = BASE_URL + "food_orders/delete";

    public static final String GET_ORDER_BY_SUPPLIER_ID_AND_STATUS = BASE_URL + "food_orders/get_food_order_by_supplierId_and_status";
    public static final String GET_ORDER_COUNT_BY_SUPPLIER_ID_AND_STATUS = BASE_URL + "food_orders/get_food_order_count_by_supplierId_and_status";
  ...
  public static final String GET_ALL_FAQ = BASE_URL + "faq/get_all_faq";
    ...
    public static final String GET_ALL_PROMOTION = BASE_URL + "promotions/get_all_promotions";
    public static final String UPDATE_STATUS = BASE_URL + "promotions/update_status";
    public static final String APPLY_PROMOTION = BASE_URL + "promotions/apply_promotion";
    public static final String DELETE_PROMOTION = BASE_URL + "promotions/delete";


    //Token
    public static final String REFRESH_TOKEN = BASE_URL + "token/refresh_token";
