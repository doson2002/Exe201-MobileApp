...
//    private ImageView imgShowCart;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (foodItem.getQuantityInventory() <= 0) {
            // Ẩn nút Add to Cart nếu món ăn đã hết hàng
            holder.btnAddToCart.setVisibility(View.GONE);

            // Hiển thị thông báo "tạm thời hết hàng"
            holder.textViewOutOfStock.setVisibility(View.VISIBLE);
        } else {
            // Hiển thị lại nút Add to Cart nếu món ăn còn hàng
            holder.btnAddToCart.setVisibility(View.VISIBLE);

            // Ẩn thông báo "tạm thời hết hàng"
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        TextView foodName, foodPrice, textViewOutOfStock;
