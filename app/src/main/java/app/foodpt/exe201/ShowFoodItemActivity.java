...
import app.foodpt.exe201.Adapter.FoodItemCustomerAdapter;
import app.foodpt.exe201.Adapter.FoodItemGroupedBySupplierAdapter;
...
import app.foodpt.exe201.Decorations.CustomDividerItemDecoration;
...
public class ShowFoodItemActivity extends AppCompatActivity{
    ...
    private ImageView backArrow, imageViewSupplier, back_arrow_search;
...
// Lấy root view
        ...
        foodAdapter = new FoodItemCustomerAdapter(foodItemList, this,cartMap, outerBasketLayout, redDot);
...
//                parentLinearLayout.removeAllViews(); // Xóa tất cả các view cũ
                        ...
                        public void onResponse(JSONArray response) {
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                try {
                                    ...
                                    int quantity = jsonObject.getInt("inventory_quantity");
                            ...
                            if (adapter == null) {
                                adapter = new FoodItemCustomerAdapter(foodItemList, ShowFoodItemActivity.this, cartMap, outerBasketLayout, redDot);
    ...
    private void setupRecyclerViewForFoodOffered(int supplierId) {
        ...
        // Thiết lập Adapter
        foodItemOfferedAdapter = new FoodItemGroupedBySupplierAdapter(foodItemOfferedList,this,cartMap,outerBasketLayout, redDot);
