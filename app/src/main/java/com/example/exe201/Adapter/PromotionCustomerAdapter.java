...
import com.example.exe201.DTO.Promotion;
...
public class PromotionCustomerAdapter extends RecyclerView.Adapter<PromotionCustomerAdapter.PromotionViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PromotionViewHolder holder, int position) {
        ...
        if (promotion.getDiscountPercentage() > 0) {
            holder.textViewValue.setText(String.format("Giảm %.0f%%", promotion.getDiscountPercentage()));
            holder.textViewDiscountValue.setText(String.format("%.0f%% OFF", promotion.getDiscountPercentage()));
