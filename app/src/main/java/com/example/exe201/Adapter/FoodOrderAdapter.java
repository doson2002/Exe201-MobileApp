...
import com.example.exe201.FoodOrderDetailActivity;
...
public class FoodOrderAdapter extends RecyclerView.Adapter<FoodOrderAdapter.FoodOrderViewHolder> {
    ...
    public void onBindViewHolder(@NonNull FoodOrderViewHolder holder, int position) {
        ...
        holder.tvTotalPrice.setText( foodOrder.getTotalPrice() + " VND");
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("foodOrder", foodOrder); // Gửi đối tượng FoodOrder sang Activity khác
